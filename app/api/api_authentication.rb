...
module API_Authentication
  ...
  def current_provider
    @current_provider ||= authenticate_current_provider(request.params.delete("api_key"))
  end

  def enforce_authentication_from_request_params
    # note that it is important to use request.params here as it differs from params

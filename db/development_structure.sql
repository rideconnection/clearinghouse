...
CREATE FUNCTION postgis_scripts_build_date() RETURNS text
    LANGUAGE sql IMMUTABLE
    AS $$SELECT '2012-12-18 19:16:44'::text AS version$$;
...
--
-- Name: SpatialIndex; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: mobility_types; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: mobility_types_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mobility_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mobility_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mobility_types_id_seq OWNED BY mobility_types.id;
...
--
-- Name: open_capacities; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE open_capacities (
    id integer NOT NULL,
    service_id integer,
    seats_open integer,
    wheelchair_spaces_open integer,
    scooter_spaces_open integer,
    notes text,
...
--
-- Name: open_capacities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE open_capacities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: open_capacities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE open_capacities_id_seq OWNED BY open_capacities.id;


--
-- Name: operating_hours; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE SEQUENCE operating_hours_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE operating_hours_id_seq OWNED BY operating_hours.id;


--
-- Name: provider_relationships; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE provider_relationships (
    id integer NOT NULL,
    requesting_provider_id integer,
    cooperating_provider_id integer,
    approved_at date,
    automatic_requester_approval boolean,
    automatic_cooperator_approval boolean,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
--
-- Name: provider_relationships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE provider_relationships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: provider_relationships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE provider_relationships_id_seq OWNED BY provider_relationships.id;
...
CREATE TABLE service_requests (
    id integer NOT NULL,
    trip_ticket_id integer,
    open_capacity_id integer,
    status integer,
    user_id integer,
    notes text,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: spatialite_history; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: spatialite_history_event_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE spatialite_history_event_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: spatialite_history_event_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE spatialite_history_event_id_seq OWNED BY spatialite_history.event_id;


--
-- Name: trip_claims; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE trip_claims (
    id integer NOT NULL,
    origin_provider_id integer,
    claimant_provider_id integer,
    trip_ticket_id integer,
    status integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    claimant_service_id integer,
    proposed_pickup_time timestamp without time zone,
    proposed_fare character varying(255),
    notes text
);


--
-- Name: trip_claims_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE trip_claims_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: trip_claims_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE trip_claims_id_seq OWNED BY trip_claims.id;


--
-- Name: trip_results; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE trip_results (
    id integer NOT NULL,
    trip_ticket_id integer,
    trip_claim_id integer,
    outcome integer,
    actual_pick_up_time time without time zone,
    actual_drop_off_time time without time zone,
    rate_type integer,
    rate integer,
    driver_id integer,
    ...
    billable_mileage double precision,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    extra_securement_count integer
);


--
-- Name: trip_results_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE trip_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: trip_results_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE trip_results_id_seq OWNED BY trip_results.id;


--
-- Name: trip_tickets; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE trip_tickets (
    id integer NOT NULL,
    origin_provider_id integer,
    origin_customer_id integer,
    claimant_provider_id integer,
    claimant_customer_id integer,
    approved_claim_id integer,
    customer_information_withheld boolean,
    customer_dob date,
    customer_address_id integer,
    customer_primary_phone character varying(255),
    customer_emergency_phone character varying(255),
    customer_impairment_description text,
    customer_boarding_time integer,
    customer_deboarding_time integer,
    customer_seats_required integer,
    customer_notes text,
    origin_trip_id integer,
    claimant_trip_id integer,
    pick_up_location_id integer,
    drop_off_location_id integer,
    earliest_pick_up_time time without time zone,
    appointment_time time without time zone,
    scheduling_priority character varying(255),
    allowed_time_variance integer,
    num_attendants integer,
    num_guests integer,
    trip_purpose_code character varying(255),
    trip_purpose_description character varying(255),
    trip_notes text,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    mobility_type_id integer,
    customer_primary_language character varying(255),
    customer_first_name character varying(255),
    customer_last_name character varying(255),
    customer_middle_name character varying(255),
    requested_pickup_time time without time zone,
    requested_drop_off_time time without time zone,
    customer_ethnicity_id integer,
    customer_identifiers hstore
);
...
CREATE SEQUENCE trip_tickets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE trip_tickets_id_seq OWNED BY trip_tickets.id;
...
--
-- Name: waypoints; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY mobility_types ALTER COLUMN id SET DEFAULT nextval('mobility_types_id_seq'::regclass);
...
ALTER TABLE ONLY open_capacities ALTER COLUMN id SET DEFAULT nextval('open_capacities_id_seq'::regclass);
...
ALTER TABLE ONLY operating_hours ALTER COLUMN id SET DEFAULT nextval('operating_hours_id_seq'::regclass);
...
ALTER TABLE ONLY provider_relationships ALTER COLUMN id SET DEFAULT nextval('provider_relationships_id_seq'::regclass);
...
ALTER TABLE ONLY spatialite_history ALTER COLUMN event_id SET DEFAULT nextval('spatialite_history_event_id_seq'::regclass);
...
ALTER TABLE ONLY trip_claims ALTER COLUMN id SET DEFAULT nextval('trip_claims_id_seq'::regclass);
...
ALTER TABLE ONLY trip_results ALTER COLUMN id SET DEFAULT nextval('trip_results_id_seq'::regclass);
...
ALTER TABLE ONLY trip_tickets ALTER COLUMN id SET DEFAULT nextval('trip_tickets_id_seq'::regclass);
...
--
-- Name: mobility_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY mobility_types
    ADD CONSTRAINT mobility_types_pkey PRIMARY KEY (id);
...
--
-- Name: open_capacities_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY open_capacities
    ADD CONSTRAINT open_capacities_pkey PRIMARY KEY (id);


--
-- Name: operating_hours_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: provider_relationships_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY provider_relationships
...
--
-- Name: spatialite_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY spatialite_history
    ADD CONSTRAINT spatialite_history_pkey PRIMARY KEY (event_id);


--
-- Name: trip_claims_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY trip_claims
    ADD CONSTRAINT trip_claims_pkey PRIMARY KEY (id);


--
-- Name: trip_results_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY trip_results
    ADD CONSTRAINT trip_results_pkey PRIMARY KEY (id);


--
-- Name: trip_tickets_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY trip_tickets
...
--
-- Name: waypoints_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: customer_identifiers; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX customer_identifiers ON trip_tickets USING gin (customer_identifiers);
...
--
-- Name: index_nonces_on_nonce_and_provider_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_nonces_on_nonce_and_provider_id ON nonces USING btree (nonce, provider_id);


--
-- Name: index_providers_on_api_key; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_providers_on_api_key ON providers USING btree (api_key);

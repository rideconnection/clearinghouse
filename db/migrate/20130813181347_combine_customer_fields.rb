class CombineCustomerFields < ActiveRecord::Migration
  def up
    ...
    remove_index :trip_tickets, :guest_or_attendant_service_animals
    remove_index :trip_tickets, :guest_or_attendant_assistive_devices
    ...
    remove_index :trip_tickets, :customer_assistive_devices
  ...
  def down
    ...
    remove_index :trip_tickets, :customer_mobility_factors

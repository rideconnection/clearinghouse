...
ActiveRecord::Schema.define(version: 20150610153648) do
  ...
  create_table "eligibility_requirements", force: :cascade do |t|
    ...
    t.string   "boolean_type", limit: 255
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end
  ...
  create_table "eligibility_rules", force: :cascade do |t|
    ...
    t.string   "trip_field",                 limit: 255
    t.string   "comparison_type",            limit: 255
    t.string   "comparison_value",           limit: 255
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
  end
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.string   "service_area_type",  limit: 255
  ...
  create_table "trip_claims", force: :cascade do |t|
    ...
    t.string   "proposed_fare",        limit: 255
    t.text     "notes"
  ...
  create_table "trip_tickets", force: :cascade do |t|
    t.string   "origin_customer_id",              limit: 255
    t.boolean  "customer_information_withheld"
    t.date     "customer_dob"
    t.integer  "customer_address_id"
    t.string   "customer_primary_phone",          limit: 255
    t.string   "customer_emergency_phone",        limit: 255
    ...
    t.string   "trip_purpose_code",               limit: 255
    t.string   "trip_purpose_description",        limit: 255
    t.text     "trip_notes"
    t.datetime "created_at",                                                  null: false
    t.datetime "updated_at",                                                  null: false
    t.string   "customer_primary_language",       limit: 255
    ...
    t.string   "customer_ethnicity",              limit: 255
    ...
    t.string   "customer_race",                   limit: 255
    ...
    t.string   "customer_service_level",          limit: 255
  ...
  add_index "trip_tickets", ["customer_eligibility_factors"], name: "customer_eligibility_factors", using: :btree
  add_index "trip_tickets", ["customer_identifiers"], name: "customer_identifiers", using: :btree
  add_index "trip_tickets", ["customer_mobility_factors"], name: "customer_mobility_factors", using: :btree
  add_index "trip_tickets", ["customer_service_animals"], name: "customer_service_animals", using: :btree
  ...
  add_index "trip_tickets", ["provider_black_list"], name: "provider_black_list", using: :btree
  add_index "trip_tickets", ["provider_white_list"], name: "provider_white_list", using: :btree
  add_index "trip_tickets", ["trip_funders"], name: "trip_funders", using: :btree
  ...
  add_index "users", ["notification_preferences"], name: "notification_preferences_index", using: :btree

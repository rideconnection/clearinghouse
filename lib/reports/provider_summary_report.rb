...
module Reports
  class ProviderSummaryReport < Report
    ...
    def initialize(user, options = {})
      ...
      section_data.merge!(summarize_object_counts_by_category(created_trips, :status_for, user))
      ...
      section_data.merge!(summarize_object_counts_by_category(created_offers, :status))
      ...
      #create_summary_section("Updated Claim Offers", section_data)

      section_data = { "Total new requests" => created_requests.count }
      section_data.merge!(summarize_object_counts_by_category(created_requests, :status))
      ...
      #create_summary_section("Updated Claim Requests", section_data)
    end
  end
end
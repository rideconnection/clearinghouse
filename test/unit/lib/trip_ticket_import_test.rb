...
class TripTicketImportTest < ActiveSupport::TestCase
  ...
  setup do
    @csv_header = 'id,origin_provider_id,origin_customer_id,origin_trip_id,customer_first_name,customer_last_name,customer_middle_name,customer_dob,customer_primary_phone,customer_emergency_phone,customer_primary_language,customer_ethnicity,customer_race,customer_information_withheld,customer_notes,customer_boarding_time,customer_deboarding_time,customer_seats_required,customer_impairment_description,customer_service_level,customer_mobility_factors,customer_service_animals,customer_eligibility_factors,num_attendants,num_guests,requested_pickup_time,earliest_pick_up_time,appointment_time,requested_drop_off_time,time_window_before,time_window_before,trip_purpose_description,trip_funders,trip_notes,scheduling_priority,customer_address_address_1,customer_address_address_2,customer_address_city,customer_address_position,customer_address_state,customer_address_zip,customer_address_phone_number,pick_up_location_address_1,pick_up_location_address_2,pick_up_location_city,pick_up_location_position,pick_up_location_state,pick_up_location_zip,pick_up_location_phone_number,drop_off_location_address_1,drop_off_location_address_2,drop_off_location_city,drop_off_location_position,drop_off_location_state,drop_off_location_zip,drop_off_location_phone_number,customer_gender,estimated_distance'
